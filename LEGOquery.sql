...
--Join themes to sets
Create view [dbo].[LEGO Project] as
...
from dbo.[LEGO Project]
--where parent_theme_name is not null
group by theme_name
order by 2 desc

--what are the total number of parts per year
...
--what percentage of sets ever released in the 21st Centruy were Harry Potter themed
;with cte as
(
...
where theme_name like '%Harry Potter%'
...
--What is the most popular color of lego ever produced in terms of quantity of parts?
